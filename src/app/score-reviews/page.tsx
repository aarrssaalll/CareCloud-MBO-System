    ...
    const updatedReviews = reviews.map(review => 
      review.id === selectedReview.id 
        ? { 
            ...review, 
            managerScore, 
            status: managerScore === review.aiScore ? 'approved' : 'overridden' as const
          }
        : review
    );
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          ...
          <p className="text-gray-600 mt-2">Review and validate AI-generated objective scores</p>
        </div>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center space-x-3">
                      <div className={`px-3 py-1 rounded-full text-xs font-medium ${
                        ...
                        review.status === 'overridden' ? 'bg-yellow-100 text-yellow-800' :
                        'bg-blue-100 text-blue-800'
                      }`}>
                        {review.status === 'approved' && <CheckCircleIcon className="w-4 h-4 inline mr-1" />}
                        {review.status === 'overridden' && <ExclamationTriangleIcon className="w-4 h-4 inline mr-1" />}
