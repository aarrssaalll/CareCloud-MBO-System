...
export default function DashboardPage() {
  ...
  // Memoized mock objectives data
  const mockObjectives = useMemo(() => [
    {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#F5F7FA] via-white to-[#F5F7FA]">
      ...
      <div className="flex">
        ...
        {/* Left Sidebar - Enhanced Stats & Navigation */}
        ...
        <main className="flex-1 flex flex-col overflow-hidden">
          ...
          <div className="flex-1 overflow-y-auto p-8 space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6">
              ...
              <div className="bg-white/90 backdrop-blur-sm rounded-3xl p-6 shadow-xl border border-[#004E9E]/10 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1 group">
                  ...
                  <div className="relative z-10">
                    <div className="flex items-center justify-between mb-8">
                      <div>
                        ...
                        <p className="text-gray-600 mt-1">Real-time performance tracking and insights</p>
                      </div>
                      <div className="flex items-center space-x-3">
                        <button className="px-4 py-2 bg-gradient-to-r from-[#004E9E] to-[#007BFF] text-white rounded-xl hover:shadow-lg transition-all duration-300 transform hover:scale-105">
                          This Quarter
                        </button>
                    ...
                    <div className="h-96 bg-gradient-to-br from-gray-50/50 to-blue-50/50 rounded-2xl border border-gray-200/50 relative overflow-hidden">
                      ...
                      <svg className="absolute inset-0 w-full h-full" viewBox="0 0 400 300">
                        ...
                        <path
                          ...
                          className="animate-pulse"
                          style={{
                            filter: 'drop-shadow(0 2px 4px rgba(0, 78, 158, 0.3))'
                          }}
                        />
                        ...
                        {/* Y-axis Labels */}
                        <text x="25" y="240" textAnchor="middle" className="text-xs fill-gray-600">0%</text>
                        <text x="25" y="190" textAnchor="middle" className="text-xs fill-gray-600">25%</text>
                        <text x="25" y="140" textAnchor="middle" className="text-xs fill-gray-600">50%</text>
                        <text x="25" y="90" textAnchor="middle" className="text-xs fill-gray-600">75%</text>
                        <text x="25" y="40" textAnchor="middle" className="text-xs fill-gray-600">100%</text>
                      </svg>
